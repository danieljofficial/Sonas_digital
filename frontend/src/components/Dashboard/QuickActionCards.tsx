...
export const QuickActionCards = () => {
  return (
    <>
      ...
      <div className="col-span-4 rounded-xl bg-gray-100 p-2">
      ...
      {/* <Card title={"Access brand kit"} imageUrl="/dashboard/colors.png" /> */}

      <div className="bg-gray-100 col-span-4 p-2 rounded-xl grid grid-rows-[auto_1fr]">
        ...
        <div className="bg-[#FFFFFF] rounded-lg flex gap-2 min-h-0 overflow-y-auto p-2">
...
const ColorCard = ({ color }: { color: string }) => {
  return (
    <div className="min-h-0 text-center ">
      <div className={`bg-[#ffc0cb] p-4 rounded-xl shadow-md h-3/4 mb-2`}></div>
      <p className={`text-center text-[${color}] text-xs p-2 font-bold`}>
        {color}
      </p>
    </div>
  );
...
const Card = ({ title, imageUrl }: { title: string; imageUrl: string }) => {
  return (
    <div className="bg-gray-100 col-span-4 p-2 rounded-xl">
      <div className=" flex flex-row justify-between items-center mb-2">
