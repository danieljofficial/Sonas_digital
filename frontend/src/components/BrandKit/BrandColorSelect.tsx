...
const BrandColorSelect = () => {
  return (
    <div className="mb-8">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 gap-4 bg-gray-50 p-4 rounded-lg">
        ...
        <div className="flex flex-col items-center">
          <button className="w-12 h-12 rounded-full border border-dashed flex items-center justify-center hover:bg-gray-100">
...
function ColorSwatch({ color, code }: { color: string; code: string }) {
  return (
    <div className="flex flex-col items-center">
      ...
      ></div>
      <span className="mt-2 text-xs text-gray-500">{code}</span>
    </div>
  );
}
